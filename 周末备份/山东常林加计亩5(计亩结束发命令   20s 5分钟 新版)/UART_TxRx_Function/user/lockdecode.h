#ifndef		_LOCKDECODE_H_
#define		_LOCKDECODE_H_
#include <stdio.h>
#include <string.h>
#include "NUC131.h"	 
//#include "globle.h"
typedef	uint32_t	uint32;
  uint32 MASKCODE=0x11223344;
 //unsigned char seedmask[8]={0x00,0x00,0x00,0x00,0x44,0x33,0x22,0x11};
  unsigned char seedmask[8];
	unsigned char maparray[8];//Ó³ÉäÊý×é
	//Header ??:
...
typedef struct {
 ...
 MD5_CTX Md5context; 
unsigned char MD5128code[16];
unsigned char YCcode[8];
